    ...
    "households": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "latrine_walls_construction": {
            "$id": "#/properties/households/items/properties/latrine_walls_construction",
            "type": "string",
            "title": "The Latrine_walls_construction Schema",
            "default": "",
            "examples": [
              ""
            ],
    ...
    "child_healths": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "others": {
            "$id": "#/properties/child_healths/items/properties/others",
            "type": "object",
            ...
            "properties": {
              "times_struggled_to_provide_food_for_child": {
                "$id": "#/properties/child_healths/items/properties/others/properties/times_struggled_to_provide_food_for_child",
                "type": "string",
              ...
              "treatment_for_malnutrition": {
                "$id": "#/properties/child_healths/items/properties/others/properties/treatment_for_malnutrition",
                "type": "string",
              ...
              "if_yes_what_treatment": {
                "$id": "#/properties/child_healths/items/properties/others/properties/if_yes_what_treatment",
                "type": "string",
