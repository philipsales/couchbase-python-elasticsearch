risk_score_child_health_mapping = {
    "risk_score_child_health":{  
        ...
        "properties":{
            ...
            "risk_score_child_health": {"type":"integer"},
            "version":{
                "type":"object",
                "properties": {
                    "number": {"type":"integer"},
...
risk_score_child_health_schema = {
  "definitions": {},
  ...
  "properties": {
    ...
    "risk_score_child_health": {
      "$id": "#/properties/risk_score_child_health",
      "type": "integer",
      "title": "The Child_health Schema",
      "default": 0,
      "examples": [
        8
      ]
